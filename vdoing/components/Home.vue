  ...
  <div class="home-wrapper">
    ...
    <MainLayout>
      <template #mainLeft>
        ...
        <Content class="theme-vdoing-content custom card-box" style="display: none" />
      </template>
    ...
    bannerBgStyle() {
      ...
      if (!bannerBg || bannerBg === 'auto') { // 默认
        if (this.$themeConfig.bodyBgImg) { // 当有bodyBgImg时，不显示背景
          ...
          return 'background-image: linear-gradient(45deg, rgb(90, 54, 148) 0%, rgb(19, 189, 206) 33%, rgb(0, 148, 217) 66%, rgb(111, 199, 181) 100%);'
        }
